...
par(mfrow=c(2,2))
  ...
  plot(x, hpc_target$Global_active_power,  type="l", col="black",xlab = "", ylab = "Energy sub metering")

  plot(x, hpc_target$Voltage, ylab = "Voltage",type ="l",xlab="datetime",axp=NULL)
  ...
  plot(x, hpc_target$Global_reactive_power, ylab = "Global_reactive_power",type ="n",xlab="datetime",yaxt="n")
  lines(x,hpc_target$Global_reactive_power,col="black")
  axis(side=2,at=seq(from=0.0,to=0.5,by=0.01))
